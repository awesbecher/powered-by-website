  ...
  return (
    <div className="min-h-screen w-full relative">
      ...
      <div className="fixed inset-0 z-0">
        <img 
          src="/lovable-uploads/b2be170c-b7fd-4333-b9b5-12a67dae4206.png" 
                  ...
                  >
                    <div className="space-y-6">
                      <div>
                        ...
                        <p>The big AI providers like OpenAI, Anthropic, and Google excel at building robust AI engines—but they rarely deliver a fully tailored, ready-to-deploy solution. We simplify & adapt these world-class models to your unique business goals, customer pain points, and existing tech stack. You give us a use case or a task flow to automate & we'll build it turn-key for you.</p>
                      </div>
