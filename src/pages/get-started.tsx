          ...
          <div className="bg-white/5 rounded-lg p-8 backdrop-blur-md border border-white/10 shadow-lg mb-12">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <div className="bg-white/5 rounded-lg p-6">
                ...
                <button 
                  onClick={() => { if (isBrowser) window.open('https://cal.com/team-powered-by-dfbtbb/get-started-today', '_blank'); }}
              ...
              <div className="bg-white/5 rounded-lg p-6">
                ...
                <button 
                  onClick={() => { if (isBrowser) window.open('/custom-ai-solutions', '_self'); }}
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-md text-white font-medium transition-colors"
                >
                  View Solutions
                </button>
              ...
              <div className="bg-white/5 rounded-lg p-6">
                ...
                <button 
                  onClick={() => { if (isBrowser) window.open('/about', '_self'); }}
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-md text-white font-medium transition-colors"
                >
                  Our Process
                </button>
              ...
              <div className="bg-white/5 rounded-lg p-6">
                ...
                <button 
                  onClick={() => { if (isBrowser) window.location.href = 'mailto:team@poweredby.agency'; }}
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-md text-white font-medium transition-colors"
                >
                  Contact Support
                </button>
