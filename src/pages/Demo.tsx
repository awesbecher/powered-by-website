      ...
      <div className="relative overflow-hidden px-6 lg:px-8 pb-8 pt-28">
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <div className={`mt-4 text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-bold transition-all duration-1000 delay-300 ease-out transform space-y-4
                ${initialLoad ? 'opacity-0 translate-x-8 -translate-y-8' : 'opacity-100 translate-x-0 translate-y-0'}`}>
              <p>Our agents can automate &amp; improve even your most complex customer-facing or internal tasks.</p>
              <p>Experience our pre-built voice agents by clicking any one of the below.</p>
              <p>Order room service! Book a test drive with Mercedes! Get an insurance quote!</p>
            </div>
          </div>
        </div>
