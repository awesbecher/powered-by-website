  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#1a0b2e] via-[#2f1c4a] to-[#1a0b2e] pt-36 pb-16">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div 
          className="prose prose-invert max-w-none [&>*]:text-white prose-h2:text-[#9b87f5] prose-h3:text-[#9b87f5] prose-p:leading-relaxed prose-p:mb-6 prose-li:text-white prose-strong:text-[#D6BCFA] prose-em:text-[#7E69AB] prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-6 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-4 prose-ul:my-6 prose-li:mb-3 prose-a:text-[#9b87f5]"
