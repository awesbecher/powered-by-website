        ...
        <div className="absolute inset-0">
          <div className="w-full h-full overflow-hidden">
            <img 
              ...
              alt={post.title}
              className="w-full h-[140%] object-cover opacity-90 transition-opacity duration-700 hover:opacity-100 object-top"
              style={{ marginTop: '-30%' }}
            />
          </div>
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#2f1c4a]/30 to-[#1a0b2e]" />
