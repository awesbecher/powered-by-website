    ...
    <div className="relative overflow-hidden px-6 lg:px-8 pt-36 pb-8">
      <div className="mx-auto max-w-7xl">
        <div className="text-center">
          <h1 
            className={`text-[64px] sm:text-[96px] font-bold tracking-tight text-white mb-4 transition-all duration-1000 ease-out transform
          ...
          <p 
            className={`mt-0 text-lg md:text-xl text-gray-300 max-w-4xl mx-auto leading-tight font-bold whitespace-nowrap transition-all duration-1000 delay-300 ease-out transform
              ${initialLoad ? 'opacity-0 translate-x-8 -translate-y-8' : 'opacity-100 translate-x-0 translate-y-0'}`}
          >
