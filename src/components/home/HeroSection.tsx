        ...
        <div className="text-center">
          ...
          <div className={`mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 transition-all duration-1000 delay-500 ease-out transform
            ...
            <Link to="/blog/understanding-ai-agents">
              <Button variant="outline" className="text-white border-[#6E59A5] hover:bg-[#6E59A5]/20 px-6 py-6 text-lg rounded-lg transition-all duration-300 transform hover:scale-105 w-full sm:w-auto">
                <HelpCircle className="mr-2 h-5 w-5" />
                What's an AI agent?
              </Button>
            </Link>
            <Link to="/contact">
              <Button className="bg-accent hover:bg-accent-dark text-white px-6 py-6 text-lg rounded-lg transition-all duration-300 transform hover:scale-105 w-full sm:w-auto">
                Book a Consultation
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Button className="bg-white hover:bg-gray-100 text-accent px-6 py-6 text-lg rounded-lg transition-all duration-300 transform hover:scale-105 w-full sm:w-auto">
