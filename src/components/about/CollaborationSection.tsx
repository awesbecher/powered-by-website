    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          <p id="collaboration-heading" className="text-3xl md:text-4xl font-semibold leading-tight text-white animate-slide-in">
          ...
          <p className="text-3xl md:text-4xl font-semibold leading-tight text-white animate-slide-in delay-200">
