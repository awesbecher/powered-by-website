  ...
  return (
    <div className={`w-full lg:w-1/2 transition-all duration-1000 delay-300 ease-out transform flex flex-col items-start justify-start
      ...
      <div className="w-full">
        <div className="border border-white rounded-3xl p-5 overflow-hidden bg-black/20 backdrop-blur-sm">
          <div className="flex flex-col items-center space-y-6 py-6">
            <h3 className="text-2xl font-bold text-white text-center">
              Ready to See How It Works?
            </h3>
            <p className="text-gray-300 text-center max-w-md">
              Book a personalized demo to see how our AI Receptionist can transform your business calls.
            </p>
            <Button 
