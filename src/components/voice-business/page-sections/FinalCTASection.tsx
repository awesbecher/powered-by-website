  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl text-center">
      ...
      <p className="text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
        Boost efficiency, reduce wait times, and enhance customer satisfaction—all with the power of a <span className="text-[#9b87f5]">Powered_by</span> AI Receptionist.
      </p>
      <Button 
