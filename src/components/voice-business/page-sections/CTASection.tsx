      ...
      <div className="relative overflow-hidden rounded-2xl">
        ...
        <div className="relative z-10 px-8 py-16 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            Book a free consultation with the <span className="text-[#9b87f5] font-bold">Powered_by</span> solutions team to learn how we could quickly and frictionlessly deliver you a receptionist that is remarkably human-like, lightning-fast, and always on.
          </p>
          <Button 
