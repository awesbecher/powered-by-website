  ...
  return (
    <div className={`text-left transition-all duration-1000 delay-500 ease-out transform
      ...
      <div className="space-y-4 text-lg text-gray-300">
        <p className="text-left leading-relaxed"><span className="bg-white text-[#6342ff] font-bold px-2 py-0.5 rounded-md">Powered_by</span> offers a free voice AI agent solution tailored specifically for your business needs. Whether you need a customer service assistant, a virtual sales rep, or a support specialist, our AI voice agents are designed to handle a wide range of business use cases with remarkable human-like conversation abilities.</p>
