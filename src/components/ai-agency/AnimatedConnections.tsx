...
export const AnimatedConnections = () => {
  return (
    ...
    >
      ...
      <circle cx="80" cy="280" r="3" fill="#4ade80" /> {/* Bottom center - Moved right */}
      ...
      <line x1="160" y1="100" x2="80" y2="280" stroke="#9b87f5" strokeWidth="1" strokeDasharray="4 4" opacity="0.6" /> {/* Bottom center line - Moved right */}
    </svg>
  );
};
