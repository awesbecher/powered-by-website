...
export const AnimatedConnections = () => {
  return (
    ...
    >
      ...
      <circle cx="220" cy="50" r="3" fill="#4ade80" /> {/* Top right - Moved down */}
      ...
      <line x1="160" y1="100" x2="220" y2="50" stroke="#9b87f5" strokeWidth="1" strokeDasharray="4 4" opacity="0.6" /> {/* Top right line - Moved down */}
