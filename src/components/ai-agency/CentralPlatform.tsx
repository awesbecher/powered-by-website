  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="absolute top-1/3 left-8 transform -translate-y-1/2 p-3 bg-gradient-to-br from-[#9b87f5]/20 to-[#9b87f5]/30 rounded-lg backdrop-blur-sm border border-white/10"
      >
