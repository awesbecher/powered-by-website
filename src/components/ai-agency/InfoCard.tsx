...
export const InfoCard: React.FC<InfoCardProps> = ({ title, description, icon: Icon }) => {
  ...
  return (
    <div className="relative group" onMouseEnter={handleMouseEnter}>
      <div className={`absolute -inset-1 bg-gradient-to-r from-purple-400 to-[#9b87f5] rounded-lg blur opacity-25 group-hover:opacity-75 transition duration-1000 group-hover:duration-200`} />
