    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        <FAQItem 
          ...
          answer="Most businesses are up and running within days. We integrate with most major business phone systems via API. If you have an older phone system, we can provide easy work-arounds." 
        />
