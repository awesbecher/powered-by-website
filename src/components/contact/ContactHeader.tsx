  ...
  return (
    ...
    >
      ...
      <p className="text-xl text-center text-gray-300 mb-8">
        Ready to put AI agents to work? Want to find a good use case? Book a Free Consultation with the <span className="bg-white/10 text-accent px-3 py-1 rounded">Powered_by</span> Solutions Design Team to learn more!
      </p>
    </div>
  );
};
