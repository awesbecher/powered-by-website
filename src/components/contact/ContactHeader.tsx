    ...
    <div className="text-center">
      ...
      <p 
        className={`mt-4 text-lg md:text-xl text-gray-300 max-w-4xl mx-auto leading-tight font-bold transition-all duration-1000 delay-300 ease-out transform
          ${initialLoad ? 'opacity-0 translate-x-8 -translate-y-8' : 'opacity-100 translate-x-0 translate-y-0'}`}
      >
        Ready to put AI agents to work? Book a Free Consultation meeting with our Solutions Design Leader. In this 30-minute meeting, we will review your AI agent project needs or help you build a vision for a project.
      </p>
    </div>
  );
};
