  ...
  return (
    <div className="space-y-4">
      ...
      <Button
        ...
        className="w-full bg-gradient-to-r from-[#8a75e3] to-[#9b87f5] hover:opacity-90 text-white font-medium py-6 h-auto text-base rounded-md transition-all shadow-md"
      >
        {isSubmitting ? (
