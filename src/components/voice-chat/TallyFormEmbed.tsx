...
export const TallyFormEmbed: React.FC<TallyFormEmbedProps> = ({ 
  ...
  const getSrcUrl = () => {
    let baseUrl = `https://tally.so/embed/${formId}?alignLeft=1&hideTitle=1&dynamicHeight=0&transparentBackground=1`;
  ...
  return (
    <div className={`tally-form-container w-full ${className}`} style={{ height: "230px", overflow: "hidden" }}>
      <iframe
        ref={iframeRef}
      ...
      ></iframe>
      <div className="text-[10px] text-gray-400 mt-0 text-left">
