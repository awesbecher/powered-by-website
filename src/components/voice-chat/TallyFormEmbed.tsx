...
export const TallyFormEmbed: React.FC<TallyFormEmbedProps> = ({ 
  ...
  return (
    <div className={`tally-form-container w-full h-full ${className}`}>
      <iframe
        ref={iframeRef}
        ...
        style={{ minHeight: "450px", height: "calc(100% - 10px)" }}
      ></iframe>
      <div className="text-[10px] text-gray-400 mt-[-10px] text-left">
