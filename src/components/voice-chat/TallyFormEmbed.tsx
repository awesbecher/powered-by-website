  ...
  return (
    <div className={`tally-form-container ${className}`}>
      <div className="border border-white/10 rounded-lg overflow-hidden glass-card">
        ...
        {/* Email disclaimer - completely eliminated spacing */}
        <div className="w-full bg-[#1a0b2e] py-1 px-4 text-white font-semibold text-left border-t border-gray-800/50">
          <p className="text-sm">*Only business or company email addresses are accepted by this form.</p>
        </div>
        
        {/* Terms disclosure - completely eliminated spacing */}
