      ...
      <div className="relative overflow-hidden rounded-2xl">
        ...
        <div className="relative z-10 px-8 py-16 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            Book a free consultation with the <span className="bg-white text-[#6342ff] font-bold px-2 py-0.5 rounded-md">Powered_by</span> solutions team to learn how we could quickly implement an AI Email Agent that handles follow-ups, inquiries, and customer communication with remarkable efficiency.
          </p>
          <Link to="/contact">
            <Button 
