...
export const samplePosts: BlogPost[] = [
  {
    ...
    content: `
      ...
      <br/>
      <h3 class="font-bold text-purple-400 pl-6">1. Answering Incoming Phone Calls</h3>
      ...
      <br/>
      <h3 class="font-bold text-purple-400 pl-6">2. Handling Reservations and Appointments</h3>
      ...
      <br/>
      <h3 class="font-bold text-purple-400 pl-6">3. Providing Product or Service Details</h3>
      ...
      <br/>
      <h3 class="font-bold text-purple-400 pl-6">4. Assisting with FAQs and Customer Support</h3>
      ...
      <br/>
      <h3 class="font-bold text-purple-400 pl-6">1. Upselling and Cross-Selling</h3>
      ...
      <br/>
      <h3 class="font-bold text-purple-400 pl-6">2. Extended Operating Hours</h3>
      ...
      <br/>
      <h3 class="font-bold text-purple-400 pl-6">3. Reduced Staffing Costs</h3>
      ...
      <br/>
      <h3 class="font-bold text-purple-400 pl-6">4. Scalable Resource Allocation</h3>
